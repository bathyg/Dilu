...
# -*- coding: CP1252 -*-
#
# generated by wxGlade not found on Wed Aug 09 12:17:27 2017
#
...
class dilu_gui_main_frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        #bitmap_size = (frame_size[0] / 3, frame_size[1] - 50)
        #image_file=wx.Bitmap("E:\\Code\\svn\\dilu_1.0\\IMG_2360.PNG",wx.BITMAP_TYPE_ANY)
        #self.image_scaled=self.scale_bitmap(image_file,bitmap_size[0],bitmap_size[1])
        #self.bitmap_1 = wx.StaticBitmap(self.tab1_addfiles, wx.ID_ANY, self.image_scaled)
